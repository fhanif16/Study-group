    ...
    return (
        <div className='mt-10 mb-10 ml-10 mr-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10'>
                <Zoom>
                    <div className="card bg-base-100 w-[300px] h-[450px] shadow-xl transition-transform transform hover:scale-105 mx-auto">
                        ...
                        <div className="card-body flex flex-col items-center text-center space-y-4 px-4">
